            ...
            <div className="poker-table__felt">
              ...
              <div className="poker-table__community">
                {gameState.communityCards.map((card, idx) => (
                  <CardDisplay key={`${card.rank}_${card.suit}`} card={card} highlighted={commHighlight.has(idx)} />
                ))}
                {/* Empty placeholders */}
        ...
        <div className="poker-bottom-bar">
          {gameState.myHoleCards.length > 0 && (
            <div className="poker-my-cards">
              <CardDisplay card={gameState.myHoleCards[0]} highlighted={holeHighlight.has(0)} />
              <CardDisplay card={gameState.myHoleCards[1]} highlighted={holeHighlight.has(1)} />
            </div>
          )}
          {bestHand && (
